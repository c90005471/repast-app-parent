...
public class ProductInfoController {
    ...
    public List<Comment> getProductCommentById(@RequestParam("productId") Long productId){
        List<Comment> productCommentById = shopCommentService.getProductCommentById(productId);
