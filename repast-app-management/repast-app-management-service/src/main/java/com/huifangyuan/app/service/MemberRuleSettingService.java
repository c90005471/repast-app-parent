...
import com.huifangyuan.app.domain.MemberRuleSetting;
import com.huifangyuan.app.mapper.MemberRuleSettingMapper;
...
public class MemberRuleSettingService extends BaseService<MemberRuleSetting> {
     ...
     *      根据店铺Id查询用户积分和成长值规则
     * @Param [shopId]
     * @Return com.huifangyuan.app.domain.MemberRuleSetting
     * @Date 2019/12/2
     */
