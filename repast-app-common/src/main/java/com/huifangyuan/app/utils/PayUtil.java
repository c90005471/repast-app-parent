...
import com.huifangyuan.app.Myconst.WXConst;
 ...
 * @Company AAA软件教育
 * @Author Zhang Wei
 * @Date Create in 2019/11/26 09:24
 * @Description
 **/
public class PayUtil {
    private static Logger logger = LoggerFactory.getLogger(PayUtil.class);

    public static JSONObject wxPay(String orderId,String openid,Float amount,HttpServletRequest request) {
